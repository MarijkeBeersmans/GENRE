...
from genre.utils import create_input_blink

def convert_blink_to_fairseq(dataset):
    ...
    for doc in tqdm(dataset, desc="Processing"):
        ...
        target.append(doc['label_title'] + ' ' + doc['label'])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "input_filename",
        type=str,
        help="Filename of the BLINK dataset",
    )
    parser.add_argument(
        "output_path",
        type=str,
